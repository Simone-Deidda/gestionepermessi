...
<html lang="it" class="h-100" >
	 <head>
	   ...
	   <title>Modifica Ruoli Elemento</title>
	 </head>
			...
			<main class="flex-shrink-0">
			  ...
			  <div class='card'>
			    	...
			    	<dl class="row">
					  ...
					  <dd class="col-sm-9">${edit_utente_attr.id}</dd>
			    	</dl>
			    	
			    	<dl class="row">
					  <dt class="col-sm-3 text-right">Username:</dt>
					  <dd class="col-sm-9">${edit_utente_attr.username}</dd>
			    	</dl>
			    	
			    	<dl class="row">
					  <dt class="col-sm-3 text-right">Data di Creazione:</dt>
					  <dd class="col-sm-9"><fmt:formatDate type="date" value = "${edit_utente_attr.dateCreated}" /></dd>
			    	</dl>
			    	
			    	<dl class="row">
					  <dt class="col-sm-3 text-right">Stato:</dt>
					  <dd class="col-sm-9">${edit_utente_attr.stato}</dd>
			    	</dl>
