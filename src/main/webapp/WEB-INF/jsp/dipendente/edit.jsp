...
<html lang="it" class="h-100" >
	 <head>
	   ...
	   <title>Modifica Credenziali Elemento</title>
	 </head>
							...
							<form:form modelAttribute="edit_dipendente_attr" method="post" action="${pageContext.request.contextPath}/dipendente/update" novalidate="novalidate" class="row g-3">
								...
								<div class="col-md-3">
									...
									<spring:bind path="codiceFiscale">
										<input type="text" name="codiceFiscale" id="codiceFiscale" class="form-control ${status.error ? 'is-invalid' : ''}" placeholder="Inserire il codice fiscale" value="${edit_dipendente_attr.codiceFiscale }" >
									</spring:bind>
									<form:errors  path="codiceFiscale" cssClass="error_field" />
								</div>
								
								<fmt:formatDate pattern='yyyy-MM-dd' var="parsedDateNascita" type='date' value='${edit_dipendente_attr.dataNascita}' />
								<div class="col-md-3">
								...
								<fmt:formatDate pattern='yyyy-MM-dd' var="parsedDateAssunzione" type='date' value='${edit_dipendente_attr.dataAssunzione}' />
								<div class="col-md-3">
								...
								<fmt:formatDate pattern='yyyy-MM-dd' var="parsedDateDimissioni" type='date' value='${edit_dipendente_attr.dataDimissioni}' />
								<div class="col-md-3">
