...
public class SecSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
		 ...
		 .antMatchers("/richiestapermesso/search/**").hasRole("DIPENDENTE_USER")
		 .antMatchers("/richiestapermesso/search").hasRole("BO_USER")
		 .antMatchers("/richiestapermesso/", "/richiestapermesso/list", "/richiestapermesso/show/**")
