...
public class RichiestaPermessoValidator implements Validator {
	...
	public void validate(Object target, Errors errors) {
		...
		if (richiestaPermessoDTO.getDataFine() != null && richiestaPermessoDTO.getDataInizio().after(richiestaPermessoDTO.getDataFine())) {
		...
		if (richiestaPermessoDTO.getTipoPermesso() == TipoPermesso.MALATTIA && richiestaPermessoDTO.getCodiceCertificato() == null) {
